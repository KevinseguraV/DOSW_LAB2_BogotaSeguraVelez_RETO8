...
public class Ave extends Animal {
    ...
    public Ave(String nombre, int edad, String sonido, String dieta,
    ...
    public void hacerSonido() {
        System.out.println(getNombre() + " canta: " + getSonido());
    }

    @Override
    public void alimentarse() {
        System.out.println(getNombre() + " picotea " + getAlimentoPreferido() +
                " (Dieta: " + getDieta() + ")");
    }
}