...
public class Reptil extends Animal {
    ...
    public Reptil(String nombre, int edad, String sonido, String dieta,
    ...
    public void hacerSonido() {
        System.out.println(getNombre() + " emite: " + getSonido());
    }

    @Override
    public void alimentarse() {
        System.out.println(getNombre() + " devora " + getAlimentoPreferido() +
                " (Dieta: " + getDieta() + ")");
    }
}